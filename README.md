...
x_origins_unconventional.txt|(output only when running in simple mode) file of sequences found only in the translated transcriptome, hence unconventional sequences
